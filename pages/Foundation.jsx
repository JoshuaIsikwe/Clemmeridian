...
const Foundation = () => {
  return (
    <div>
        ...
        <div class="division-title absolute uppercase font-bold text-justify bottom-1/3 left-4 text-2xl md:text-4xl lg:text-6xl">Clemmeridian Care Foundation</div>
