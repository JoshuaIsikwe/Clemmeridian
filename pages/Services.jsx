      ...
      <div className="page-title text-center text-4xl m-24">
       ...
       <section className='service-board hidden lg:flex w-full m-auto mb-20 bg-blue-600 md:max-w-5xl md:h-80v'>
          <div className='service-card flex flex-1 flex-col'>
            ...
            <div className='services-box-icon h-2/4 bg-blue-600 flex items-center justify-center ease-in duration-300 hover:bg-red-600 hover:scale-105'>  <Image src='/images/Investment.jpg'  width='341' height='240' alt='/'></Image></div>
          </div>
          <div className='service-card flex flex-1 flex-col'>
            <div className='services-box-icon h-2/4 bg-blue-600 flex items-center justify-center ease-in duration-300 hover:bg-red-600 hover:scale-105 '><Image src='/images/consult.jpg'  width='341' height='240' alt='/'></Image></div>
          ...
          <div className='service-card flex flex-1 flex-col'>
            ...
            <div className='services-box-icon h-2/4 bg-blue-600 flex items-center justify-center ease-in duration-300 hover:bg-red-600 hover:scale-105 '><Image src='/images/training.jpg'  width='341' height='240' alt='/'></Image></div>
          </div>
        </section>

        <section className='lg:hidden'>
          <Image src='/images/servicesMobile.jpg' width='1024' height='600' alt='/'></Image>
        </section>
        ...
        <section className='service-section flex flex-col m-auto lg: w-4/5'>
          <motion.div variants={framerVariants} initial="hiddenX" whileInView="visibleX" viewport={{ once: true }} className='service-item mb-5'>
