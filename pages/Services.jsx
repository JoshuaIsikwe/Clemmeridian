      ...
      <div className="page-title text-center text-4xl m-24">
       ...
       <section className="service-board hidden lg:flex w-full m-auto mb-20 bg-blue-600 md:max-w-5xl md:h-80v">
          <div className="service-card flex flex-1 flex-col">
            <div className=' h-60 md:h-2/4 bg-blue-600 flex items-center justify-center ease-in duration-300 hover:bg-red-600 hover:scale-105'><h2 className='font-bold uppercase'>Investment</h2></div>
          ...
          <div className="service-card flex flex-1 flex-col">
            ...
            <div className=' h-60 md:h-2/4 bg-blue-600 flex items-center justify-center ease-in duration-300 hover:bg-red-600 hover:scale-105'><h2 className='font-bold uppercase'>Consulting & Advisory Services</h2></div>
          </div>
          <div className="service-card flex flex-1 flex-col">
            <div className='h-60 md:h-2/4 bg-blue-600 flex items-center justify-center ease-in duration-300 hover:bg-red-600 hover:scale-105'><h2 className='font-bold uppercase'>Business Development & Training</h2></div>
        ...
        <section className="industries flex flex-col items-center p-10">
            ...
            <div className="list flex flex-wrap list-none ">
              <div className=' mr-10'>
                ...
                <GiFarmTractor className='text-xl text-red-600 mr-6'/> <p>Agriculture </p>
                </div>
                <div className=" flex mt-5">
                <GiGreenPower className='text-xl text-red-600 mr-6'/> <p>Renewable Energy </p>
                </div>
                <div className=" flex mt-5">
                  <FaCertificate className='text-xl text-red-600 mr-6'/> <p>Retail </p>
                </div>
                <div className=" flex mt-5">
                <GiPayMoney className='text-xl text-red-600 mr-6'/> <p>Private Equity & Principal Investors </p>
                </div>
                <div className=" flex mt-5">
                <RiCommunityFill className='text-xl text-red-600 mr-6'/> <p>Real Estate</p>
                </div>
              </div>
              <div className='right-list'>
                <div className=" flex mt-5 ">
                <GiOilDrum className='text-xl text-red-600 mr-6'/> <p>Oil & Gas </p>
                </div>
                <div className=" flex mt-5 ">
                  <FaCoins className='text-xl text-red-600 mr-6'/> <p>Financial Services</p>
                </div>
                <div className=" flex mt-5">
                <FaTruckMoving className='text-xl text-red-600 mr-6'/> <p>Transportation </p>
                </div>
                <div className=" flex mt-5">
                <FaCertificate className='text-xl text-red-600 mr-6'/>  <p>Public and Social Sector </p>
                </div>
              </div>
            </div>
        </section>
